...
public class App extends JFrame {
    ...
    private void createUI() {
        setTitle("Nedbank IPO Timeline Generator");
        ...
        headerPanel.setBackground(new Color(100, 130, 100));
        JLabel titleLabel = new JLabel("Nedbank IPO Timeline Generator");
    ...
    private void generateTimeline(ActionEvent e) {
        try {
            ...
            List<NedbankIPOTimelineGenerator.IPOPhase> timeline =
                    NedbankIPOTimelineGenerator.generateTimeline(ipoDate);

            Object[][] data = new Object[timeline.size()][3];
            for(int i = 0; i < timeline.size(); i++) {
                NedbankIPOTimelineGenerator.IPOPhase phase = timeline.get(i);
